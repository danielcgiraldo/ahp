    ...
    return (
        <form className="flex flex-col items-center" onSubmit={handleSubmit}>
            ...
            <div className="w-full">
                ...
                <h4 className="font-medium mb-4">Características Básicas</h4>
                <ul className="grid gap-4">
                    <RelativeWeightSelector
            ...
            <button
                disabled={loading}
                className={`bg-callable w-full py-3 text-center rounded font-medium text-white mt-8 hover:bg-callable-hover transition-colors ${
                    loading && "bg-callable-hover"
                }`}
            >
                {loading ? (
                    <>
                        <Loading className="inline w-4 h-4 mr-1 -mt-1 text-white animate-spin" />{" "}
                        Cargando...
                    </>
                ) : (
                    "Calcular"
